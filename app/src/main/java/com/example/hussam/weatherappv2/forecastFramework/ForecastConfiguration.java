...
import com.example.hussam.weatherappv2.forecastFramework.Constants;
...
/**
 * Used in {@link com.example.hussam.weatherappv2.forecastFramework.ForecastClient#create(ForecastConfiguration)} to configure the ForecastClient. The only
...
public class ForecastConfiguration
{
    ...
    public static class Builder
    {
        ...
        private int cacheSize = com.example.hussam.weatherappv2.forecastFramework.Constants.DEFAULT_CACHE_SIZE;
        private int cacheMaxAge = com.example.hussam.weatherappv2.forecastFramework.Constants.DEFAULT_CACHE_AGE;
        private int connectionTimeout = com.example.hussam.weatherappv2.forecastFramework.Constants.DEFAULT_CONNECTION_TIMEOUT;
