...
public class LogInActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String SkipLogin = sharedPref.getString("email","not found");
        if(SkipLogin.contains("@"))
        {
            goToWeatherActivity(SkipLogin);
        }
    ...
    public void CheckFinalResult()
    {
        if(TempPassword.equalsIgnoreCase(PasswordHolder))
        {
            ...
            editor.commit();
            goToWeatherActivity(EmailHolder);
        }
        else {
    ...
    //Jump to the Weather Activity
    private void goToWeatherActivity(String email)
    {
